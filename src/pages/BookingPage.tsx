...
import {
  Scissors, CheckCircle, ChevronLeft, ChevronRight,
          ...
          <div className="ds-card p-5 space-y-3 mb-4">
            <div className="flex items-center gap-3">
              {branding?.logoUrl
                ...
                : <div className="w-11 h-11 rounded-full bg-brand flex items-center justify-center flex-shrink-0"><Scissors size={18} className="text-white"/></div>}
